...
class TemplateGenerator:
    ...
    def _generate_markdown(
        ...
        lines.append("> Edit this file and sync back with: md2jira --markdown {file} --epic {epic_key} --execute")
...
def run_generate(args, console: Console) -> int:
    ...
    console.header(f"md2jira Generate {Symbols.FILE}")
    ...
    if result.success and not dry_run:
        ...
        console.item(f"Sync changes: md2jira --markdown {result.output_path} --epic {epic_key} --execute")
