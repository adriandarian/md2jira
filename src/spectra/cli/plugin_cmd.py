...
def run_plugin_search(
    ...
    Returns:
        Exit code
    """
    from spectra.adapters.plugin_marketplace import GitHubPluginRegistry
    from spectra.core.ports.plugin_marketplace import PluginCategory, SearchQuery
...
def run_plugin_install(
    ...
    """
    from spectra.adapters.plugin_marketplace import GitHubPluginRegistry
    from spectra.core.ports.plugin_marketplace import InstallationError, PluginNotFoundError
...
def run_plugin_uninstall(console: Console, name: str) -> int:
    ...
    """
    from spectra.adapters.plugin_marketplace import GitHubPluginRegistry
    from spectra.core.ports.plugin_marketplace import PluginNotFoundError
...
def run_plugin_publish(
    ...
    """
    from spectra.adapters.plugin_marketplace import GitHubPluginRegistry
    from spectra.core.ports.plugin_marketplace import AuthenticationError, PublishError
