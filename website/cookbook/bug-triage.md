...
Efficiently manage bug backlogs using md2jira for structured bug tracking.
...
md2jira -m bugs/q1-2025.md -e BUG-100 --output json | jq '
...
```bash
md2jira -m bugs/q1-2025.md -e BUG-100 -x
```
