...
*Synchronize Markdown, YAML, JSON, and Notion specs with Jira, GitHub, Linear, and Azure DevOps*
...
- 🔄 **Universal Sync** - Multi-platform support for Jira, GitHub, Linear, and Azure DevOps.
